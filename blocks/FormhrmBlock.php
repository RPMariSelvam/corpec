 ...
 */
class FormhrmBlock extends PhpBlock
{
    /**
    ...
    public $defaultMailSubject = 'HRM and Payroll Form submitted on Asalta - An End-to-End Business Automation Software';
