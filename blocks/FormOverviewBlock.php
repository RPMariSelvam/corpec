 ...
 */
class FormOverviewBlock extends PhpBlock
{
    /**
    ...
    public $defaultMailSubject = 'ARRANGE A FREE DEMO  Form submitted on Asalta - An End-to-End Business Automation Software';
