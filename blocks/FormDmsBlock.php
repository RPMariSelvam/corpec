 ...
 */
class FormDmsBlock extends PhpBlock
{
    /**
    ...
    public $defaultMailSubject = 'DMS Form submitted on Asalta - An End-to-End Business Automation Software';
