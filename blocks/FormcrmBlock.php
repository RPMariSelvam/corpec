 ...
 */
class FormcrmBlock extends PhpBlock
{
    /**
    ...
    public $defaultMailSubject = 'CRM Form submitted on Asalta - An End-to-End Business Automation Software';
