                                                        ...
                                                        <tr>
                                                            <td style="padding-bottom:20px" valign="top">
                                                                ...
                                                                <p style="margin-left: 20px;">
                                                                    ...
                                                                    <strong>Customer Login Email :</strong> <?= ($email) ? $email : '' ?> <br/>
                                                                     <strong>Organisation Name :</strong> <?= ($organisationname) ? $organisationname : '' ?> <br/>
                                                                    <strong>Mobile :</strong> <?= ($phone) ? : '' ?> <br/>
                                                                    <strong>Support Title :</strong> <?= ($projecttitle) ? $projecttitle : '' ?> <br/>
                                                                    <strong>Priority :</strong> <?= ($priority) ? $priority : '' ?> <br/>
                                                                     <br/><br/>
                                                                    <?= ($message) ? $message : '' ?>
                                                                </p>
                                                                <p></p>
