                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <td style="padding-bottom:20px" valign="top">
                                                ...
                                                <p style="margin-left: 20px;">
                                                    <strong>Name :</strong> <?= ($firstname) ? $firstname : '' ?> <br/>
                                                    <strong>Last Name :</strong> <?= ($lastname) ? $lastname : '' ?> <br/>

                                                    <strong>Email :</strong> <?= ($email) ? $email : '' ?> <br/>
                                                    <strong>Type of query :</strong> <?= ($typeofquery) ? $typeofquery : '' ?> <br/>
                                                    <strong>Phone Number :</strong> <?= ($phone) ? $phone : '' ?> <br/>
                                                    <br/>
                                                    <?= ($message) ? $message : '' ?>
                                                </p>
                                                <p></p>
