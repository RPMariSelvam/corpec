                                    ...
                                    <div class="simple-conversion">
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                <input type="text" id="dmsform" class="form-control <?= (!$this->extraValue('nameErrorFlag')) ? 'red' : '' ?>" id="name" name="name" placeholder="Name" value="<?= isset($_POST['name']) ? $_POST['name'] : '';?>">
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                <input type="emtextail" class="form-control <?= (!$this->extraValue('messageErrorFlag')) ? 'red' : '' ?>" id="message" name="message" placeholder="Company Name" value="<?= isset($_POST['message']) ? $_POST['message'] : '';?>">
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                <input type="emtextail" class="form-control <?= (!$this->extraValue('contactnumberErrorFlag')) ? 'red' : '' ?>" id="contactnumber" name="contactnumber" placeholder="Contact Number" value="<?= isset($_POST['contactnumber']) ? $_POST['contactnumber'] : '';?>">
                                        ...
                                        <div class="row recaptcha">
                                            ...
                                            <div class="col-sm-12 col-md-4 form-recaptcha">
                                                <div id="re_captcha" class="g-recaptcha <?= (!$this->extraValue('recaptchaErrorFlag')) ? 'error' : '' ?>" data-sitekey="6LeydXkUAAAAAJxT0vWZLdX9u1V57MNqcUgiIn_z">
